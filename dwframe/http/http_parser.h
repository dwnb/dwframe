...
public:
    /// HTTP解析类的智能指针
    using pointer = std::shared_ptr<HttpRequestParser>;
     ...
     */
    HttpRequest::pointer getData() const { return m_data;}
...
public:
     ...
     */
    HttpResponse::pointer getData() const { return m_data;}
