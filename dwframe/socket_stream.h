 ...
 */
#ifndef __dwframe_SOCKET_STREAM_H__
#define __dwframe_SOCKET_STREAM_H__
...
public:
    using pointer =  std::shared_ptr<SocketStream>;
     ...
     */
    SocketStream(Socket::pointer sock, bool owner = true);
     ...
     *      @retval <0 socket错误
     */
    virtual int read(ByteArray::pointer ba, size_t length) override;
     ...
     *      @retval <0 socket错误
     */
    virtual int write(ByteArray::pointer ba, size_t length) override;
     ...
     * @brief 返回Socket类
     */
    Socket::pointer getSocket() const { return m_socket;}
